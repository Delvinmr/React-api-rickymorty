        ...
        <div className="max-w-96">
           <Logo />
            <p className="mt-6 text-sm text-gray-500">
                Este proyecto es de un tutorial de un curso realizado en Udemy pero, le agregue paginacion y pagina de detalles
            </p>
            <div className="flex items-center gap-2 mt-3">
                <a href="https://www.linkedin.com/in/delvin-martinez-rosario-989a92190/">
                ...
                <a href="https://github.com/Delvinmr" target="_blanck">
                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
